...
Public NotInheritable Class Encryption
    ...
    ' // This module is something that I typed out a few weeks before adding it to this project for something else I was working on, however it is virtually the same as the above tutorial link //
